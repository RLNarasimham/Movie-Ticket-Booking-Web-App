      ...
      {featured && (
        <section className="max-w-7xl mx-auto px-4 py-12">
          <div className="flex items-center space-x-2 mb-8">
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Featured Movie</h2>
          </div>
          <div className="bg-white dark:bg-gray-800 text-black dark:text-white rounded-xl shadow-lg overflow-hidden md:flex">
            ...
            <div className="p-6 md:w-2/3">
              <div className="flex items-center space-x-2 mb-4">
                <h3 className="text-3xl font-bold dark:text-white">{featured.title}</h3>
                <p className="text-gray-600 dark:text-gray-300">{featured.release_date}</p>
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">{featured.overview}</p>
