...
const FAQs: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 pt-16 dark:from-gray-900 dark:to-gray-950 py-12 px-2 sm:px-4 flex items-center justify-center transition-colors duration-300">
          ...
          {faqs.map((faq, idx) => (
            ...
            >
              ...
              >
                ...
                <FiChevronDown
                  className={`h-6 w-6 text-gray-500 dark:text-gray-300 transition-transform duration-300 ${openIndex === idx ? "rotate-180" : ""
                    }`}
                />
              </button>
              <div
                className={`transition-all duration-300 px-6 overflow-hidden ${openIndex === idx
