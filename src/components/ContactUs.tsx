...
const ContactUs: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-950 py-6 px-2 sm:px-4 flex items-center justify-center transition-colors duration-300 pt-16">
