...
const ComingSoon: React.FC = () => {
  return (
    <section className="px-4 sm:px-6 pt-16 flex flex-col justify-center w-full bg-gray-100 dark:bg-gray-900 min-h-[calc(100vh-64px)] transition-colors duration-300">
